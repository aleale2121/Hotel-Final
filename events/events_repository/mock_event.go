...
func (mCatRepo *MockEventsRepo) EventsById(id int) (*entity.Events, []error) {
...
func (mCatRepo *MockEventsRepo) UpdateEvents(news entity.Events) (*entity.Events, []error) {
	cat := entity.EventsMock
	return &cat, nil
}

func (mCatRepo *MockEventsRepo) DeleteEvents(id int) (*entity.Events, []error) {
	cat := entity.EventsMock
	if id != 1 {
		return nil, []error{errors.New("Not found")}
	}
...
func (mCatRepo *MockEventsRepo) StoreEvents(news entity.Events) (*entity.Events, []error) {
	cat := news
	return &cat, nil
}
