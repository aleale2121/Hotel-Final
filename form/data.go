...
//PriceRX represents prices matching pattern
var PriceRX = regexp.MustCompile("[0-9]+")
// PhoneRX represents phone number matching pattern
...
// MatchesPattern checks if a given input form field matches a given pattern
