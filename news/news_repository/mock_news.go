...
func (mCatRepo *MockNewsRepo) NewsById(id int) (*entity.News, []error) {
	ctg := entity.NewsMock
	if id == 1 {
		return &ctg, nil
	}
...
func (mCatRepo *MockNewsRepo) DeleteNews(id int) (*entity.News, []error) {
	cat := entity.NewsMock
	if id != 1 {
		return nil, []error{errors.New("Not found")}
	}
...
func (mCatRepo *MockNewsRepo) NewsFive() ([]entity.News, []error) {
	ctgs := []entity.News{entity.NewsMock}
	return ctgs, nil
}